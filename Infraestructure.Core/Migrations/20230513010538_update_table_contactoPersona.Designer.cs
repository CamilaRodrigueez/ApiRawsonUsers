...
namespace Infraestructure.Core.Migrations
{
    ...
    [Migration("20230513010538_update_table_contactoPersona")]
    partial class update_table_contactoPersona
    {
            ...
            modelBuilder.Entity("Infraestructure.Entity.Models.ContactoPersonaEntity", b =>
                {
                    ...
                    b.HasIndex("IdPersona")
                        .IsUnique()
                        .HasDatabaseName("Index_IdPersona");

                    b.HasIndex("IdTipoContacto")
                        .IsUnique()
                        .HasDatabaseName("Index_IdTipoContacto");
